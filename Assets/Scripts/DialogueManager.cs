...
public class DialogueManager : MonoBehaviour
{
    ...
    public void Task2Dialogue()
    {
        
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "Are you Mama Joji?" });
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "Where’s That?" });
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "I am, but I'm not from around here." });
    ...
    public void Task2Complete()
    {
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "Well, are you going to tell me what he looks like?" });
    ...
    //task3- to Babe Jona
    public void Task3Dialogue()
    {
        
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "Are you Baba Jonah?" });
   ...
   //letter
    ...
    //Honey Dialogue
    public void TaskHoneyDialogue()
    {
        
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "Here you go, Mama. Baba Jonah is quite a looker." });
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Mama Joji", dialogueText = "Heyyy!!! That's my crush you speak of!" });
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "He is all yours. Besides, I'm like a baby to you guys. It would be questionable if he, you know?" });
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Mama Joji", dialogueText = "No, I don’t know. Do tell?" });
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "Never mind. Do you know where I might find some real honey?" });
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Mama Joji", dialogueText = "Ooohhh, honey. I would love some too." });
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "Well??" });
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "And???" });
    ...
    public void TaskHoneyProcess()
    {
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "Well, your advice was cryptic, but I figured it out." });
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "In shock)... " });
    ...
    public void Task4Dialogue()
    {
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "And let me guess? You want me to traverse the Pharmacy of God to get the herbs that will help?" });
    ...
    public void Task5Dialogue()
    {
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "OKAY Old man..." });

        
        DisplayNextLine();
    }

    public void Task5Return()
    {
    ...
    //Back to villagers
    public void Task5Complete()
    {
        
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "I have brought the item as requested. It was a challenging but rewarding task." });
        ...
        dialogueQueue.Enqueue(new Dialogue { speakerName = "Susan", dialogueText = "May I have some of those herbs, they may be of use to me later." });
